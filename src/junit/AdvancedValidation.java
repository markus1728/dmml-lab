...
public class AdvancedValidation {
	 ...
	 * @throws Exception
	 */
	public static void comparePredictions(KENearestNeighbor myClassifier, IBk wekaClassifier, Instance testInstance) throws Exception {
	...
	public void testClassify() throws Exception {
		...
		classifier.setMetric(new SelectedTag(1, KENearestNeighbor.TAGS_DISTANCE));
		classifier.setDistanceWeighting(new SelectedTag(1, KENearestNeighbor.TAGS_WEIGHTING));
		classifier.setNormalization(new SelectedTag(0, KENearestNeighbor.TAGS_NORM));
	...
	public void testCorrectnessUnweightedManhattank1() throws Exception {
		...
		classifier.setkNearest(1);
		classifier.setMetric(new SelectedTag(0, KENearestNeighbor.TAGS_DISTANCE));
		classifier.setDistanceWeighting(new SelectedTag(0, KENearestNeighbor.TAGS_WEIGHTING));
		classifier.setNormalization(new SelectedTag(0, KENearestNeighbor.TAGS_NORM));
	...
	public void testCorrectnessNominalWeightedManhattank10Normalized() throws Exception {
		...
		classifier.setMetric(new SelectedTag(0, KENearestNeighbor.TAGS_DISTANCE));
		classifier.setDistanceWeighting(new SelectedTag(1, KENearestNeighbor.TAGS_WEIGHTING));
		classifier.setNormalization(new SelectedTag(1, KENearestNeighbor.TAGS_NORM));
